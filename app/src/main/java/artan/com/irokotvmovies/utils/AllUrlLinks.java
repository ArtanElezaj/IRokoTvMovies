...
public class AllUrlLinks {
    ...
    public static final String END_POINT_MOVIE_DETAILS = "?api_key=" + API_KEY;

    public static final String VIDEOS = "/videos";
    public static final String YOUTUBE_API_KEY = "AIzaSyD4XR840EQg9mWHdpkwjvbQu4y6VOBv9v4";
    ...
    public static final String M_SERVICE_VIDEO_DATA = "mServiceDetailsData";
